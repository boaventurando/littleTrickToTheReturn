...
public class Game {
    ...
    private void createItems() {
        ...
        private void printWelcome ()
        {
            ...
            System.out.println("You are walking around brazilian biomas and you may discover if all plants are in the right places.");
            System.out.println("Besides this, you have the task to improve the level of oxygen by spreading and taking care of the plants you find in the way. But be careful and pay attention! Plants will tell what they need and some of them need nothing but to be there exactly where they are. Type 'help' if you need help.");
            System.out.println();
